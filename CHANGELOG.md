...
- `ANY` / `ALL` / `SOME` quantified comparison operators with subqueries: `col > Any(subquery)`, `col > All(subquery)`, `col = Some(subquery)`. Standard SQL, supported on all five dialects. (#196)
