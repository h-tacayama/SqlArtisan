...
## [Unreleased]
### Added
- Added task-oriented documentation (#227): three guides — [Dapper + SqlArtisan from scratch](https://github.com/h-tacayama/SqlArtisan/blob/main/docs/guides/dapper-quickstart.md), [introducing SqlArtisan into an EF Core project](https://github.com/h-tacayama/SqlArtisan/blob/main/docs/guides/ef-core-integration.md) (same-connection/transaction interop via a `DbParameter` bridge or Dapper), and [using SqlArtisan with AI coding assistants](https://github.com/h-tacayama/SqlArtisan/blob/main/docs/guides/ai-assistants.md) — plus a [query cookbook](https://github.com/h-tacayama/SqlArtisan/blob/main/docs/cookbook.md) of realistic end-to-end queries whose emitted SQL is pinned by exact-SQL unit tests.
