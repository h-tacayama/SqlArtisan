...
## [Unreleased]
### Added
- Added a [comparison guide](https://github.com/h-tacayama/SqlArtisan/blob/main/docs/comparison.md) — how SqlArtisan compares to EF Core, linq2db, SqlKata, Dapper.SqlBuilder, and InterpolatedSql on philosophy, type safety, machine-verifiability, dialect handling, execution, and performance, plus when NOT to choose SqlArtisan. (#226)
