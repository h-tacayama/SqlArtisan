...
PR: the `MatrixSweepCatalogTests` completeness pair, the ADR 0011
`DialectGuardTwinTests` twin gate, and the ADR 0020
`DateTimePartNumberingTests` numbering gate, via an FQN filter. The
