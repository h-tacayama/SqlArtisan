...
and §5's "before merging" final pass gates whatever the audit gates — a release, a
...
Same rule as sa-panel-diff-review's §2 — mechanical output is not what must stay
