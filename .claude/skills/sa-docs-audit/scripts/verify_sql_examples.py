...
Usage:  python3 .claude/skills/sa-docs-audit/scripts/verify_sql_examples.py [workdir]
...
internal sealed class UsersTable : DbTableBase {
    public UsersTable(string a="") : base("users",a) {
        ...
        Data=new(this,"data");IsActive=new(this,"is_active");Region=new(this,"region");FirstName=new(this,"first_name");LastName=new(this,"last_name");Tags=new(this,"tags");Embedding=new(this,"embedding");
    }
    ...
    public DbColumn Data{get;} public DbColumn IsActive{get;} public DbColumn Region{get;} public DbColumn FirstName{get;} public DbColumn LastName{get;} public DbColumn Tags{get;} public DbColumn Embedding{get;}
}
