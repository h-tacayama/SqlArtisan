...
{
    /// <summary>Builds the row from <c>column == value</c> assignments, emitting the column list and one <c>VALUES</c> row from them (<c>INSERT INTO t (code, name) VALUES (:0, :1)</c>).</summary>
    ...
    /// <summary>Appends a positional <c>VALUES (...)</c> row for the table's columns in declaration order.</summary>
