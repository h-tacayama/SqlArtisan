...
/// <summary>
/// The state after <c>INSERT IGNORE INTO table (col, ...)</c>: supply rows with <c>Values(...)</c>
/// or feed them from a <c>SELECT</c> (or a <c>WITH</c> CTE). Not buildable until a row source is
/// supplied.
/// </summary>
