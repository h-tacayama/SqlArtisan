...
/// <summary>The ability to add a <c>RETURNING</c> clause that reads back columns from the affected rows (PostgreSQL/SQLite/Oracle; SQL Server uses <c>OUTPUT</c>).</summary>
public interface IReturning : ISqlBuilder
{
    /// <summary>Appends <c>RETURNING expr, ...</c> to read values from the inserted, updated, or deleted rows.</summary>
