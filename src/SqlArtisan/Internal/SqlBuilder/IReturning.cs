...
public interface IReturning : ISqlBuilder
{
    ...
    /// </summary>
    /// <param name="expressions">The columns or expressions to return; use plain (unaliased) expressions, then chain <see cref="IReturningBuilder.Into"/> to bind them to output parameters.</param>
