...
{
    /// <summary>
    /// Appends <c>INNER JOIN table</c> (MySQL multi-table <c>UPDATE</c>); supply its predicate with
    /// the following <c>On(...)</c>.
    /// </summary>
    ...
    /// <summary>
    /// Appends <c>LEFT JOIN table</c> (MySQL multi-table <c>UPDATE</c>); supply its predicate with
    /// the following <c>On(...)</c>.
    /// </summary>
    ...
    /// <summary>
    /// Appends <c>RIGHT JOIN table</c> (MySQL multi-table <c>UPDATE</c>); supply its predicate with
    /// the following <c>On(...)</c>.
    /// </summary>
    ...
    /// <returns>The builder positioned for <c>FROM</c>, <c>OUTPUT</c>, <c>WHERE</c>, <c>RETURNING</c>, or build.</returns>
