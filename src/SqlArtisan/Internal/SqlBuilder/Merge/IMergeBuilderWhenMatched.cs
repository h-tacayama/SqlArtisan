...
{
    /// <summary>Appends <c>THEN UPDATE SET col = value, ...</c>, updating the matched rows.</summary>
    ...
    /// <summary>Appends <c>THEN DELETE</c>, removing the matched rows (SQL Server).</summary>
