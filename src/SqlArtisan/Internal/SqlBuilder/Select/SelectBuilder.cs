    ...
    ISelectBuilderWithRollup
{
    ...
    public ISelectBuilderFrom CrossApply(ISubquery subquery, UntypedDerivedTable alias)
    {
    ...
    public ISelectBuilderFrom CrossJoinLateral(ISubquery subquery, UntypedDerivedTable alias)
    {
    ...
    public ISelectBuilderJoin JoinLateral(ISubquery subquery, UntypedDerivedTable alias)
    {
    ...
    public ISelectBuilderFrom LeftJoinLateral(ISubquery subquery, UntypedDerivedTable alias)
    {
    ...
    public ISelectBuilderFrom OuterApply(ISubquery subquery, UntypedDerivedTable alias)
    {
