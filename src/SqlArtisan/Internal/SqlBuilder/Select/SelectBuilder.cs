    ...
    ISelectBuilderWithRollup
{
    ...
    public ISelectBuilderFrom CrossApply(ISubquery subquery, AdHocDerivedTable alias)
    {
    ...
    public ISelectBuilderFrom CrossJoinLateral(ISubquery subquery, AdHocDerivedTable alias)
    {
    ...
    public ISelectBuilderJoin JoinLateral(ISubquery subquery, AdHocDerivedTable alias)
    {
    ...
    public ISelectBuilderFrom LeftJoinLateral(ISubquery subquery, AdHocDerivedTable alias)
    {
    ...
    public ISelectBuilderFrom OuterApply(ISubquery subquery, AdHocDerivedTable alias)
    {
