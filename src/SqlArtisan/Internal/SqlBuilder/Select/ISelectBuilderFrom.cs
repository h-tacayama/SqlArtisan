...
/// <summary>
/// The builder state after <c>FROM</c>: join more tables, filter, group, order, paginate, lock with
/// <c>FOR UPDATE</c>, combine with a set operator, or build.
/// </summary>
public interface ISelectBuilderFrom :
    ISqlBuilder,
    IForUpdate,
    IJoinOperator,
    IPagination,
