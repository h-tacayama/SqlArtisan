...
/// <summary>The parameters bound by a built <see cref="SqlStatement"/>, each a marker name paired with its value, in bind order.</summary>
public sealed class SqlParameters
{
    ...
    /// <summary>Gets the number of bound parameters.</summary>
    public int Count => _parameters.Count;

    /// <summary>Gets the parameter marker names, in bind order.</summary>
    public IEnumerable<string> ParameterNames => _parameters.Select(p => p.Key);

    /// <summary>Invokes <paramref name="action"/> once per parameter, in bind order, with its marker name and value.</summary>
    ...
    /// <summary>Gets the value of the named parameter, cast to <typeparamref name="T"/>.</summary>
