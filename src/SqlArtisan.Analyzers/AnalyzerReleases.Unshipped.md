...
SQLA0104 | SqlArtisan.Dialect | Warning | A literal argument value the target dialect rejects: a DateTimePart outside what it accepts for that function, a RegexpOptions member outside its match-parameter alphabet, or a negative constant row count.
