...
SQLA0105 | SqlArtisan.Dialect | Warning | A literal argument value the target dialect rejects: a RegexpOptions member outside its match-parameter alphabet, or a negative constant row count.
