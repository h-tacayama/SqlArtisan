...
internal static class DialectSupportResolver
{
    public readonly struct Result
    {
        ...
        /// <see cref="IsVersionBound"/> is <see langword="true"/> — the SQLA0101
        ...
        /// target version falling short of the matrix's bound (SQLA0101) rather
        /// than the entry's plain dialect bool (SQLA0100).
        /// </summary>
