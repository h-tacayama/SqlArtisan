...
| `SqlArtisan.Schema` | `SQLA0007`–`SQLA0010` | does it agree with what your table classes say the columns are? |
...
- **The dialect-independent rules need a configured target too.**
  `SQLA0005` and the schema-aware `SQLA0007`–`SQLA0010` report facts that
