...
Write SQL, in C#. A type-safe SQL query builder where the SQL you write is the SQL that runs—cross-database portability is a deliberate non-goal.
...
So **cross-database portability is a deliberate non-goal**: target Oracle and you write Oracle SQL; target PostgreSQL and you write PostgreSQL SQL.
